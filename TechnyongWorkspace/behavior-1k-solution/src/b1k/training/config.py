...
class DataConfig:
    ...
    behavior_dataset_root: str | None = "/home/data/Technyong_workspace/behavior-1k-solution/data/behavior_datasets"
    ...
    TrainConfig(
        ...
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                ...
                # Updated code 
                # behavior_dataset_root="/root/data/behavior_224_rgb",
        ...
        #Updated to downloaded local file
        # weight_loader=weight_loaders.PiBehaviorWeightLoader("/root/models/behavior_submission/checkpoint_1"),
