...
echo "  uv run scripts/serve_b1k.py --task-checkpoint-mapping task_checkpoint_mapping.json policy:checkpoint --policy.config pi_behavior_b1k_fast --policy.dir /home/data/Technyong_workspace/models/behavior_submission/checkpoint_1"
echo ""
