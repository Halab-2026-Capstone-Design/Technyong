...
class DataConfig:
    ...
    task_names: List[str] | None = None  # if None, loads all tasks
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                prompt_from_task=False, behavior_dataset_root="/home/data/Technyong_workspace/behavior-1k-solution/data/behavior_224_rgb", use_per_timestamp_norm=True,
            ),
        ...
        num_flow_samples=15,
        weight_loader=weight_loaders.PiBehaviorWeightLoader("/home/data/Technyong_workspace/models/behavior_submission/checkpoint_1"),
    ...
    # 🧪 3. Task 001 forward pass 테스트용 (picking_up_trash, 20 steps)
    TrainConfig(
        name="pi_behavior_b1k_task001_test",
        exp_name="task001_test",
        project_name="B1K",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30, action_dim=32, use_correlated_noise=False,
        ...
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                ...
                behavior_dataset_root="/home/data/Technyong_workspace/behavior-1k-solution/data/behavior_224_rgb",
                use_per_timestamp_norm=False,
                episodes_index=list(range(10010, 13010, 10)),  # task 001 (picking_up_trash) 에피소드
            ),
            use_delta_joint_actions=True,
            use_fast_tokenization=False,
        ),
        lr_schedule=_optimizer.CosineDecaySchedule(warmup_steps=10, peak_lr=1e-4, decay_steps=100, decay_lr=1e-5),
        num_flow_samples=2,
        weight_loader=weight_loaders.PiBehaviorWeightLoader("/home/data/Technyong_workspace/models/behavior_submission/checkpoint_1/params"),
        num_train_steps=20,
        batch_size=8,
        num_workers=4,
        assets_base_dir="./outputs/assets",
    ...
    # 🚀 4. Task 001 실제 학습 (picking_up_trash, pretrained 체크포인트 fine-tuning)
    TrainConfig(
        name="pi_behavior_b1k_task001_train",
        exp_name="task001_finetune",
        project_name="B1K",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30, action_dim=32, use_correlated_noise=False,
        ...
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                ...
                use_per_timestamp_norm=False,
                episodes_index=None,
                task_names=["picking_up_trash"],  # task 001만 로드
            ),
            use_delta_joint_actions=True,
            use_fast_tokenization=False,
        ),
        lr_schedule=_optimizer.CosineDecaySchedule(
            warmup_steps=100, peak_lr=2e-5, decay_steps=3000, decay_lr=1e-6
        ),
        num_flow_samples=1,
        weight_loader=weight_loaders.PiBehaviorWeightLoader(
            "/home/data/Technyong_workspace/models/behavior_submission/checkpoint_1/params"
        ),
    ...
    #성능 검사용 task 5개로 우선 학습
    TrainConfig(
        name="pi_behavior_b1k_multi_sft",
        exp_name="multi_task_sft_5tasks",
        project_name="B1K_SFT",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30, action_dim=32, 
            freeze_vision_backbone=True, 
        ),
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                ...
                use_per_timestamp_norm=False,
                task_names=[
                    "turning_on_radio",         # Task 0
                    "picking_up_trash",        # Task 1
                    "bringing_water",          # Task 17
                    "tidying_bedroom",         # Task 18
                    "putting_shoes_on_rack"    # Task 22
                ],
            ),
            use_delta_joint_actions=True,
            use_fast_tokenization=False,
        ...
        lr_schedule=_optimizer.CosineDecaySchedule(
            warmup_steps=500, peak_lr=2.5e-5, decay_steps=20000, decay_lr=1e-6
        ),
        num_train_steps=20000, 
        weight_loader=weight_loaders.PiBehaviorWeightLoader(
            "/home/data/Technyong_workspace/models/behavior_submission/checkpoint_2/params"
        ),
        freeze_filter=nnx_utils.PathRegex("PaliGemma/.*"),
        ema_decay=None,
        batch_size=8,
        num_workers=8,
        assets_base_dir="./outputs/assets",
    ...
    TrainConfig(
        name="pi_behavior_b1k_task0000_zero2",
        exp_name="task000_test2",
        project_name="B1K",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30, action_dim=32, use_correlated_noise=False,
            freeze_vision_backbone=True,  # 비전은 고정, action expert만 학습
        ...
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                ...
                use_per_timestamp_norm=False,
                episodes_index=None,
                task_names=["turning_on_radio"],  # task 001만 로드
            ),
            use_delta_joint_actions=True,
            use_fast_tokenization=False,
        ),
    ...
    TrainConfig(
        name="pi_behavior_b1k_multi_sft_0.1.17.18.22",
        exp_name="multi_task_sft_5tasks",
        project_name="B1K_SFT",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30, action_dim=32, 
        ...
        lr_schedule=_optimizer.CosineDecaySchedule(
            warmup_steps=500, peak_lr=2.5e-5, decay_steps=3000, decay_lr=1e-6
        ),
    ...
    TrainConfig(
        name="pi_behavior_b1k_16tasks_zero",
        exp_name="checkpoint2_16tasks_zero",
        project_name="B1K_SFT",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30,
            action_dim=32,
    ...
    TrainConfig(
        name="pi_behavior_b1k_3tasks_sft_0.1.17",
        exp_name="checkpoint2_3tasks_sft_0_1_17",
        project_name="B1K_SFT",
        model=pi_behavior_config.PiBehaviorConfig(
            action_horizon=30,
            action_dim=32,
